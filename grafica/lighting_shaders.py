    ...
    def __init__(self):
        ...
        fragment_shader = """
            ...
            void main()
            {
                ...
                newRed = result.r * 0.393f + result.g * 0.769f + result.b * 0.189f;
                newBlue = result.r * 0.349f + result.g * 0.686f + result.b * 0.168f;
                newGreen = result.r * 0.272f + result.g * 0.534f + result.b * 0.131f;
