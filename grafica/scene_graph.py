...
def drawSceneGraphNode(node, pipeline, transformName, shininess = 100, att = 0.05, parentTransform=tr.identity()):
    ...
    # so this draw function is called recursively
        ...
        for child in node.childs:
            drawSceneGraphNode(child, pipeline, transformName,shininess,att, newTransform)
